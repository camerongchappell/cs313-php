...
<body>
   <div id="login">
      <h1 class="text-center text-black font-weight-bold pt-6">Create Account</h1>
      <div class="container">
         <div id="login-row" class="row justify-content-center align-items-center">
               <div id="login-column" class="col-md-6">
                  <div id="login-box" class="col-md-12">

                     <form id="login-form" class="form" action="createAccount.php" method="post">
                           ...
                           <div class="form-group text-center">
                              <input type="submit" name="submit" class="btn btn-primary btn-md" value="Create Account">
                           </div>
